...
function Header() {
  return (
    <div >
        ...
        <nav className='w-[1320px] h-[87px] mt-[45px] ml-[300px]  text-white absolute'>
            <p className='ml-[700px] text-2xl '><span className='text-primary'>Food</span>tuck</p>
              <div className='w-auto h-[38px] flex '>
                    
              <div className='w-[675px] h-6 mt-[6px]'>
                 <ul className='flex gap-12 '>
                    <li>Home <p className='w-[7px] h-[7px] bg-primary ml-4 rounded-full'></p> </li>
                    <li>Menu</li>
                    <li>Blog</li>
                    <li>Pages</li>
                    <li className='flex'>About <FaAngleDown className='mt-2'/> </li>
                    <li>Shop</li>
                    <li>Contact</li>
                 </ul>
              </div>
